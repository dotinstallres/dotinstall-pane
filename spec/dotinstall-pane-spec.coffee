...
describe "DotinstallPane", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('dotinstall-pane')

  describe "when the dotinstall-pane:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'dotinstall-pane:toggle'
        expect(dotinstallPanePanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'dotinstall-pane:toggle'
        expect(dotinstallPaneElement).not.toBeVisible()
